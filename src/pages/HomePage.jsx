...
const HomePage = ({ user, profileExists }) => {
  ...
  return (
    <div>
      <section className="flex flex-col-reverse lg:flex-row items-center px-10 md:px-20 py-10 gap-7 md:gap-12">
        ...
        <div className=" w-full md:w-3/5 flex justify-center">
          <img src={heroImg} alt="Healthy eating" className="w-full h-full  object-cover" />
        </div>
      </section>

      {/* HOW IT WORKS */}
      <section className="px-10 py-10">
        <h2 className="text-3xl font-bold mb-5 md:mb-10">How It Works</h2>

        <div className="grid md:grid-cols-3 items-center gap-5 md:gap-10">
          <div className='bg-blue-300 shadow rounded-md md:rounded-2xl p-6'>
          ...
          <div className='bg-lime-300 shadow rounded-md md:rounded-2xl p-6'>
            <div className="text-green-600 text-4xl mb-3">🔍</div>
            <h3 className="font-semibold text-lg">2. Log your meals</h3>
            <p className="text-gray-600 text-sm mt-2">Search or scan food items</p>
          </div>

          <div className='bg-amber-300 shadow rounded-md md:rounded-2xl p-6 mb-10 md:mb-0'>
            <div className="text-green-600 text-4xl mb-3">📊</div>
